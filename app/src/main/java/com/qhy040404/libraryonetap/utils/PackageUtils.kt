...
object PackageUtils {
    ...
    private val appInfo: ApplicationInfo = LibraryOneTapApp.app.packageManager.getApplicationInfo(LibraryOneTapApp.app.packageName, PackageManager.GET_META_DATA)
